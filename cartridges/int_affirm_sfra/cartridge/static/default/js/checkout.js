...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../affirm/node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout.js":
/*!****************************************************************************!*\
  !*** ./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout.js ***!
  \****************************************************************************/
/*! no static exports found */
...
$(document).ready(function () {
  processInclude(__webpack_require__(/*! ./checkout/checkout */ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/checkout.js"));
  processInclude(__webpack_require__(/*! ./checkout/billing */ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/billing.js"));
});

/***/ }),

/***/ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/billing.js":
/*!************************************************************************************!*\
  !*** ./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/billing.js ***!
  \************************************************************************************/
/*! no static exports found */
...
function updatePaymentInformation(order) {
  ...
  if (order.billing.payment && order.billing.payment.selectedPaymentInstruments && order.billing.payment.selectedPaymentInstruments.length > 0 && $('.payment-information').data('payment-method-id') === 'CREDIT_CARD') {
...
/***/ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/checkout.js":
/*!*************************************************************************************!*\
  !*** ./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/checkout.js ***!
  \*************************************************************************************/
/*! no static exports found */
...
var billingHelpers = __webpack_require__(/*! ./billing */ "./cartridges/int_affirm_sfra/cartridge/client/default/js/checkout/billing.js");
    ...
    var members = {
      ...
      updateStage: function () {
        ...
        if (stage === 'shipping') {
          ...
          $('#affirm-config').data('vcnenabled') && $('#vcn-data').data('vcncomplete')) {
            // or vcn is enabled but complete
            $.ajax({

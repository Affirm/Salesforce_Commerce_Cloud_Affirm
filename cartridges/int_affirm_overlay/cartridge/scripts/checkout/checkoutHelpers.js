...
//var affirm = require('int_affirm_sfra/cartridge/controllers/Affirm')
...
function validatePayment(req, currentBasket) {
   ...
   // applicablePaymentMethods = require('int_affirm_sfra/cartridge/scripts/affirm.ds').Init(currentBasket, applicablePaymentMethods);

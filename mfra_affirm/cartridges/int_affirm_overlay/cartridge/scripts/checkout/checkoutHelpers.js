...
//var affirm = require('int_affirm_mobile_first/cartridge/controllers/Affirm')
...
function validatePayment(req, currentBasket) {
   ...
   // applicablePaymentMethods = require('int_affirm_mobile_first/cartridge/scripts/affirm.ds').Init(currentBasket, applicablePaymentMethods);

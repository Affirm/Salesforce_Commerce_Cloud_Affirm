...
var affirm = require('int_affirm_mobile_first/cartridge/scripts/affirm.ds');
...
var PaymentMgr = require('dw/order/PaymentMgr');
var affirmHelper = require('int_affirm_mobile_first/cartridge/scripts/utils/affirmHelper');
...
server.post('Update', function(req, res, next){
	...
	var hookName = "dw.int_affirm_mobile_first.payment_instrument." + affirm.data.VCNPaymentInstrument().toLowerCase();
